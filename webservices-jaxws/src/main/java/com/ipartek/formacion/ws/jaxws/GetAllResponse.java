...
@XmlRootElement(name = "obtenerTodosResponse", namespace = "hhtp://com.ipartek.formacion/types")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "obtenerTodosResponse", namespace = "hhtp://com.ipartek.formacion/types")
