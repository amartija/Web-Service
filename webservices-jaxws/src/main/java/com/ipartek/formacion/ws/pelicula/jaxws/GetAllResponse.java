...
@XmlRootElement(name = "obtenerListadoResponse", namespace = "http://com.ipartek.formacion/types")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "obtenerListadoResponse", namespace = "http://com.ipartek.formacion/types")
